...
--[=[
	...
	From Quenty's [HttpPromise](https://github.com/Quenty/NevermoreEngine/blob/main/src/httppromise/src/Server/HttpPromise.lua).
	Slightly modified to work with the Promises/A+ API.
...
function HttpPromise.request(request: HTTPRequest)
...
function HttpPromise.json(request: HTTPRequest | string)
